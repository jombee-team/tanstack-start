...
export function ResourceListExample() {
  ...
  const handleTaggedWithRemove = useCallback(() => setTaggedWith(undefined), [])
  ...
  function renderItem(item: (typeof items)[number]) {
    ...
    const shortcutActions = latestOrderUrl ? [{ content: 'View latest order', url: latestOrderUrl }] : undefined
    return (
      <ResourceItem
        id={id}
        key={id}
